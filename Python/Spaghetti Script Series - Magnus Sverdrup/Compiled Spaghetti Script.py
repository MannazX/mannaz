...
def Chaos4():
    ...
    Solved_Eq(2,5,5,20,5,1)

"""
slope is a function that gives the slope for the discretised equation.
y_list is a list that contains the values for the descretised equation.
p_list is a list that contains the values for the "continuos" equation.
"""         
...
"""
A is the first heaveside function that is equal to zero if x is smaller than zero.
B is the second heaveside function that is equal to one if x is smaller than zero.
x is the number of integar values that the heaveside function uses as input values.
Av is the vectorization of the function A and is the plotted values of heaveside function A.
Bv is the vectorization of the function B and is the plotted values of heaveside function B.
y is the sine function that is plotted to fit heaveside function A.
g is the cosine function that is plotted to fit heaveside function B.
"""
...
def Chaos8():
    ...
    def plot(a,b,n):
        ...
        plt.subplot(1,2,1)
        plt.plot(len_arr,rand_arr,'gd')
        plt.subplot(1,2,2)
        plt.hist(rand_arr,color="g")
    plot(1,10,20)
